...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONFIGTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONFIGTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONFIGTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONFIGTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONFIGTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONFIGTYPE actions', async () => {
      const arg = 42666;
